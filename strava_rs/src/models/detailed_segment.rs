...
pub struct DetailedSegment {
    ...
    pub start_latlng: Option<crate::models::LatLng>,
    #[serde(rename = "end_latlng", skip_serializing_if = "Option::is_none")]
    pub end_latlng: Option<crate::models::LatLng>,
    ...
    pub athlete_pr_effort: Option<crate::models::SummarySegmentEffort>,
    #[serde(rename = "athlete_segment_stats", skip_serializing_if = "Option::is_none")]
    pub athlete_segment_stats: Option<crate::models::SummaryPrSegmentEffort>,
    ...
    pub map: Option<crate::models::PolylineMap>,
